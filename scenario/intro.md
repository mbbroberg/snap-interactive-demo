This demo gets you started with Snap, the open telemetry framework. We will install from a prebuilt package so we don't have to worry about any source code. 
